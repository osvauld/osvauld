	...
	>
		...
		{:else if newPasswordView}
			<div class="h-full flex flex-col items-center overflow-y-auto">
				<NewPassword {isLoaderActive} onReturn={handlePasswordChangeSubmit} />
			</div>
		{:else}
			<form
			...
			>
				...
				<main class="grow flex justify-center items-center my-20">
					<fieldset class="border-0 p-0 m-0">
						<label for="passphrase" class="font-normal text-white self-start"
