...
{#if uiState.showNavigationPanel}
	<nav
		class="w-[22.5rem] shrink-0 h-full max-h-full py-4 px-4 whitespace-nowrap relative border-r border-osvauld-borderColor"
	...
	>
		...
		<!-- Tree Navigation -->
		<div class="flex-1 h-full overflow-y-auto scrollbar-thin">
			<TreeNavigation />
		</div>
	</nav>
{/if}
