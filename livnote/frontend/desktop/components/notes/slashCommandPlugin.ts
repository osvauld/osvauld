...
function getCommands(schema: Schema): SlashCommandItem[] {
  ...
  if (schema.nodes.table) {
    commands.push({
      ...
      icon: `<span class="menu-item-icon-span">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M3 6a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6zm3-1.5A1.5 1.5 0 0 0 4.5 6v2.25h15V6A1.5 1.5 0 0 0 18 4.5H6zm13.5 5.25h-15v2.25h15v-2.25zm-15 3.75v2.25A1.5 1.5 0 0 0 6 19.5h12a1.5 1.5 0 0 0 1.5-1.5v-2.25h-15zm15-1.5v-2.25h-15v2.25h15z"></path>
      </svg>
      </span>`,
      command: (state, dispatch, view) => {
        return insertTable()(state, dispatch, view);
      },
    });
  }
