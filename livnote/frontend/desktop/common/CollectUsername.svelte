<script lang="ts">
	let { onProceed, collectedUsername = $bindable() } = $props<{
		onProceed: () => void;
...
>
	<div class="flex flex-col items-center justify-center mb-4">
		...
		<p class="text-sm font-inter font-normal text-textActive text-center mt-4">
			Only seen by people you share something with. <br />There is no central
			registry for these names.
		</p>
	</div>
	<div class="mb-4">
		<label for="username" class="font-normal mb-2 text-white self-start block"
