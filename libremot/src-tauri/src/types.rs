...
pub struct ResourcePreview {
    pub id: String,
    pub preview: String,  // For notes, empty for chats
    pub title: String,     // For notes, empty for chats
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub participant_name: Option<String>,  // Comma-separated names
    #[serde(skip_serializing_if = "Option::is_none")]
    pub participant_id: Option<String>,    // For 1-on-1 chats
    #[serde(skip_serializing_if = "Option::is_none")]
