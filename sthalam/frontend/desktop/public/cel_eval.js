...
(js=>
 ...
 (function(globalThis){
   ...
   (globalThis))
({"link":[["runtime-19fd5996",0],["prelude-d7e4b000",0],["stdlib-40b2cbc1",[]],["yojson-26490c3b",[2]],["str-127c9347",[2]],["unix-764e5c28",[2]],["cel-0a87f8ed",[2,3,4,5]],["jsoo_runtime-1e55b178",[2]],["js_of_ocaml-97350c3b",[2,7]],["ocamlcommon-8a36ea94",[2]],["astlib-a0a06e10",[2,9]],["ppxlib_ast-87543642",[2,10]],["ocaml_shadow-0ebf7fe4",[]],["ppxlib_print_diff-fec2dd44",[2]],["ppx_derivers-a78b6a53",[2]],["ppxlib_traverse_builtins-8299787c",[2]],["sexplib0-90abbc8a",[2]],["stdppx-884388c1",[2,16]],["ppxlib-b0b76339",[2,10,11,12,13,14,15,16,17]],["ppx_js-7c7f9733",[2,9,11,18]],["ppx_js_rewriter-c5d03a14",[19]],["dune__exe__Cel_wasm-9aa84240",[2,4,6,8]],["std_exit-73ee5fad",[2]],["start-92e6439a",0]],"generated":(a=>{var
...
a(),"new_1":(a,b)=>new
a(b),"obj_0":(a,b,c,d,e,f,g)=>({evaluate:a,interpolate:b,evaluateGrid:c,compileToGLSL:d,generateAssetId:e,version:f,supportedFunctions:g}),"obj_1":()=>({}),"obj_10":(a,b,c)=>({success:a,result:b,error:c}),"obj_11":(a,b,c)=>({success:a,result:b,error:c}),"obj_12":(a,b,c)=>({success:a,result:b,error:c}),"obj_13":(a,b,c)=>({success:a,result:b,error:c}),"obj_2":(a,b,c,d,e)=>({success:a,glslExpr:b,shaderCode:c,uniforms:d,error:e}),"obj_3":(a,b,c,d,e)=>({success:a,glslExpr:b,shaderCode:c,uniforms:d,error:e}),"obj_4":(a,b,c,d,e)=>({success:a,glslExpr:b,shaderCode:c,uniforms:d,error:e}),"obj_5":(a,b,c)=>({name:a,celVar:b,glslType:c}),"obj_6":(a,b,c)=>({success:a,output:b,error:c}),"obj_7":(a,b,c)=>({success:a,output:b,error:c}),"obj_8":(a,b,c)=>({success:a,result:b,error:c}),"obj_9":(a,b,c)=>({success:a,result:b,error:c})}}})(globalThis),"src":"cel_wasm.bc.wasm.assets"});
