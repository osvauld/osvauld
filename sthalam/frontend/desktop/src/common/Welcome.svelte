...
>
	...
	>
		...
		<div
			class="flex px-3 mt-4 border rounded-lg border-osvauld-iconblack focus-within:border-osvauld-activeBorder bg-osvauld-frameblack"
		>
			<input
				class="text-white p-2 border-0 tracking-wider font-normal border-transparent focus:ring-0 focus:border-osvauld-activeBorder focus:outline-none bg-osvauld-frameblack"
				{type}
				id="passphrase"
				autocomplete="off"
				value={passphrase}
