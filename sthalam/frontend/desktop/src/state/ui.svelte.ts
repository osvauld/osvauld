...
class UIState {
  ...
  /**
   * Show sovereign node modal
   */
  showSovereignNodeModalFn() {
    this.showSovereignNodeModal = true;
  }

  /**
   * Hide sovereign node modal
   */
  hideSovereignNodeModal() {
    this.showSovereignNodeModal = false;
  }
