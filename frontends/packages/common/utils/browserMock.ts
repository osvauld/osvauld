    ...
    sendMessage: async ({ action, data }) => {
      try {
        ...
        const handlerMap = {
          ...
          'addCredential': (data) => invoke('handle_add_resource', { input: data }),
          ...
          'getCredentialsForFolder': (data) => invoke('handle_get_resources_for_folder', { input: data }),
          'startP2PListner': () => invoke('start_p2p_listener'),
          'deleteCredential': (data: any) => invoke('soft_delete_resource', { input: data }),
          ...
          'shareResource': (data: any) => invoke('share_resource', { input: data }),
        };
